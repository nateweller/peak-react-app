    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div className="transition__dialog__background bg-gray-900 bg-opacity-80 absolute top-0 right-0 bottom-0 left-0" />

                    <OutsideClickHandler onOutsideClick={ () => setIsOpen(false) }>
                        <div 
                            className={
                                `transition__dialog__content relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 
